...
class FriendRequests extends Component {
  ...
  getFriends() {
    fetch("http://104.131.160.216:9000/user/friends/" + this.props.auth.user.id)
      .then((res) => res.json())
      .then((res) => {
        this.setState({
          friends: {
  ...
  acceptRequest(event) {
    ...
    if (this.state.userOther == "") {
      ...
      const url = "http://104.131.160.216:9000/user/friends/request/accept";
      const options = {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
  ...
  declineRequest(event) {
    ...
    if (this.state.userOther == "") {
      ...
      const url = "http://104.131.160.216:9000/user/friends/request/decline";
      const options = {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
