...
class SongList extends Component {
  ...
  songListPlayTrack(song) {
    const url = "http://104.131.160.216:9000/user/queue/play_song";
    const options = {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
  ...
  addFavorite(song) {
    const url = "http://104.131.160.216:9000/user/favorites/songs/add";
    const options = {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
  ...
  removeFavorite(song) {
    const url = "http://104.131.160.216:9000/user/favorites/songs/remove";
    const options = {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
  ...
  addToForest(song, forest) {
    const url = "http://104.131.160.216:9000/user/forests/addToForest";
    const options = {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
  ...
  removeFromForest(song, forest) {
    const url = "http://104.131.160.216:9000/user/forests/removeFromForest";
    const options = {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
  ...
  getFavorites(userid) {
    fetch("http://104.131.160.216:9000/user/favorites/songs/" + this.props.user.id)
      .then((res) => res.json())
      .then((res) => {
        var fave_list = [];
